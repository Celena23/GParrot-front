<template>
  <div id="footer" >
  <div class="bg-primary px-4 py-5 md:px-6 lg:px-8 w-full">
    <div class="bg-primary">
      <div class="grid flex">
        ...
        <div class="col-12 md:col-6 sm:align-items-end text-gray-200 flex flex-column justify-content-start md:align-items-end">
